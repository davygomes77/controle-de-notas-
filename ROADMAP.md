...
## Release 1.0 - Concluída

- [x] Criar interface nativa com Tkinter e ttk.
- [x] Implementar vetor de cinco alunos.
- [x] Implementar matriz de notas `5 x 3`.
- [x] Validar notas entre `0` e `10`.
- [x] Calcular soma, média e situação individual.
- [x] Exibir resumo geral da turma.
...
- [ ] Exibir uma legenda visual para aprovado e reprovado.
